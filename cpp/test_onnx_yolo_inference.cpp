...
int main() {
  try {
    const std::vector<std::string> image_paths = {
        "../python/video_frames/frame_0138.jpg",
        "../python/video_frames/frame_0139.jpg",
        "../python/video_frames/frame_0148.jpg",
    };
    ...
    onnx::yolo::Runner static_runner("../python/golf-car-static.onnx");
    Ort::Value static_output = static_runner.run(frames.front());
    assert_yolo_output(static_output, 1, "static model");

    onnx::yolo::Runner dynamic_runner("../python/golf-car-dynamic.onnx");
